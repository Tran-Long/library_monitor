    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_format', models.CharField(choices=[('date_month_year', 'Date Month Year'), ('month_year', 'Month Year'), ('quarter_year', 'Quarter Year'), ('year', 'Year')], default='date_month_year', help_text='Date format for displaying publication date', max_length=20)),
